...
const sampleTemplates: Template[] = [
	{
		...
		category: 'Business',
		previewImage:
			'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400&h=600',
	...
	},
	{
		...
		category: 'Services',
		previewImage:
			'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&h=600',
	...
	},
	{
		...
		category: 'Events',
		previewImage:
			'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&h=600',
	...
	},
	{
		...
		category: 'Product',
		previewImage:
			'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=600',
	...
	},
	{
		...
		category: 'Retail',
		previewImage:
			'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=400&h=600',
	...
	// New templates
	{
		...
		category: 'Services',
		previewImage:
			'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=400&h=600',
	...
	},
	{
		...
		category: 'Events',
		previewImage:
			'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=400&h=600',
	...
	},
	{
		...
		category: 'Food & Beverage',
		previewImage:
			'https://images.unsplash.com/photo-1495147466023-ac5c588e2e94?w=400&h=600',
	...
	},
	{
		...
		category: 'Events',
		previewImage:
			'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=400&h=600',
	...
	},
	{
		...
		category: 'Retail',
		previewImage:
			'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=400&h=600',
	...
	},
	{
		...
		category: 'Services',
		previewImage:
			'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=600',
	...
	},
	{
		...
		category: 'Business',
		previewImage:
			'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?w=400&h=600',
	...
	},
	{
		...
		category: 'Product',
		previewImage:
			'https://images.unsplash.com/photo-1550009158-9ebf69173e03?w=400&h=600',
	...
	},
	{
		...
		category: 'Events',
		previewImage:
			'https://images.unsplash.com/photo-1556911220-bff31c812dba?w=400&h=600',
	...
	},
	{
		...
		category: 'Services',
		previewImage:
			'https://images.unsplash.com/photo-1560253023-3ec5d502959f?w=400&h=600',
	...
	},
	{
		...
		category: 'Business',
		previewImage:
			'https://images.unsplash.com/photo-1560185127-6ed189bf02f4?w=400&h=600',
						...
						<CardContent className="p-0">
							...
							<div className="p-4 sm:p-5 md:p-6 bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-sm">
								...
								<Button
									onClick={() => onTemplateSelect(template)}
									size="lg"
									className="w-full bg-gradient-to-r from-purple-500/80 to-blue-500/80 hover:from-purple-500 hover:to-blue-500 text-white text-sm md:text-base font-medium transition-all duration-300 hover:shadow-lg py-3 md:py-4 rounded-full"
								>
									Select Template
								</Button>
							</div>
